...
public class ShowShape extends Applet {
	public ShowShape() {
		...
		t3d2.lookAt(new Point3d(0, 0, 2), new Point3d(0, .4, 0),
				new Vector3d(0, 1, 0));
		t3d2.invert();
	...
	public BranchGroup createSceneGraph() {
		...
		// create SHAPE to show
		Column shape =  new Column(.05f, .3f, app);
		//shape.getAppearance().setMaterial(m);
	...
	public static void main(String[] args) {
		new MainFrame(new ShowShape(), 1024, 768);
	}
}